...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body.dark-mode .client-info-box {
            background: var(--gray-50);
            border-color: var(--border-color);
        }

        body.dark-mode .client-info-box .label {
            color: var(--text-secondary);
        }

        body.dark-mode .client-info-box .value {
            color: var(--text-primary);
        }
        ...
        .form-card-header .form-icon {
            width: 48px;
            height: 48px            background: var(--red-light);
            color: var(--red-primary);
            border-radius: 12px;
            display: flex;
            align-items: center;
        ...
        .client-info-box .value .policy-tag {
            background: var(--red-light);
            color: var(--red-primary);
            padding: 2px 12px;
            border-radius: var(--radius-full);
    ...
    <main class="main-content">
        ...
        <div class="page-header">
            <div class="page-header-left">
                ...
                <p class="page-subtitle">Update the client's information below</p>
            </div>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p>Update the client's personal and policy details</p>
                </div>
            </div>
            ...
            <div class="client-info-box">
                ...
                <div class="info-item">
                    ...
                    <span class="value"><span class="policy-tag"><?= htmlspecialchars($client['policy_number']) ?></span></span>
                </div>
                <div class="info-item">
            ...
            <form method="POST" id="editForm" onsubmit="return validateForm()">
                <div class="form-grid">
                    <div class="form-group full-width">
                        ...
                        <span class="hint"><i class="fas fa-info-circle"></i> The client's full legal name</span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="phone" id="phone" value="<?= htmlspecialchars($client['phone']) ?>" required>
                    ...
                    <div class="form-group full-width">
                        ...
                        <select name="policy_type" id="policy_type" required>
                            ...
                            <option value="Life" <?= $client['policy_type'] == 'Life' ? 'selected' : '' ?>>❤️ Life Insurance</option>
                            ...
                            <option value="Travel" <?= $client['policy_type'] == 'Travel' ? 'selected' : '' ?>>✈️ Travel Insurance</option>
                    ...
                    <div class="form-group full-width">
                        ...
                        <input type="date" name="expiry_date" id="expiry_date" value="<?= $client['expiry_date'] ?>" required>
